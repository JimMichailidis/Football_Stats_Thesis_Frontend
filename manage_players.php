            ...
            <div class="section-box">
                ...
                <div class="row g-2">
                    <div class="col-md-1"><label class="form-label">ID</label>
                        <input type="number" name="ID" class="form-control form-control-sm" required>
                    </div>
            ...
            <div class="section-box" style="border-top-color: #198754;">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-1"><label class="form-label">Pass %</label>
                        <input type="number" step="0.01" name="Passes_Percentage" class="form-control form-control-sm">
                    </div>
                    ...
                    <div class="col-md-1"><label class="form-label">Cross %</label>
                        <input type="number" step="0.01" name="Crosses_Percentage" class="form-control form-control-sm">
                    </div>
                    ...
                    <div class="col-md-1"><label class="form-label">Succ. F3rd</label>
                        <input type="number" name="Successful_Final_Third_Passes" class="form-control form-control-sm">
                    </div>
            ...
            <div class="section-box" style="border-top-color: #fd7e14;">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-1"><label class="form-label">Carr. Goal</label>
                        <input type="number" name="Carries_Ended_with_Goal" class="form-control form-control-sm">
                    </div>

                    <div class="col-md-1"><label class="form-label">Carr. Assist</label>
                        <input type="number" name="Carries_Ended_with_Assist" class="form-control form-control-sm">
                    </div>

                    <div class="col-md-1"><label class="form-label">Carr. Shot</label>
                        <input type="number" name="Carries_Ended_with_Shot" class="form-control form-control-sm">
                    </div>

                    <div class="col-md-2"><label class="form-label">Carr. Chance</label>
                        <input type="number" name="Carries_Ended_with_Chance" class="form-control form-control-sm">
                    </div>
            ...
            <div class="section-box" style="border-top-color: #ffc107;">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-1"><label class="form-label">Gr. %</label>
                        <input type="number" step="0.01" name="gDuels_Percentage" class="form-control form-control-sm">
                    </div>
            ...
            <div class="section-box" style="border-top-color: #6f42c1;">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-1"><label class="form-label">xG Conc.</label>
                        <input type="number" step="0.01" name="xG_Threat_Conceded" class="form-control form-control-sm">
                    </div>
                    ...
                    <div class="col-md-1"><label class="form-label">Save %</label>
                        <input type="number" step="0.01" name="Saves_Percentage" class="form-control form-control-sm">
                    </div>
                    ...
                    <div class="col-md-2"><label class="form-label">G. Prevented</label>
                        <input type="number" step="0.01" name="Goals_Prevented" class="form-control form-control-sm">
                    </div>
                </div>
            </div>
